...
for i in energies:
    ...
    source_nucleus.append("ell_"+str(i).rjust(3, '0')+"_"+celltype+"_nucleus_"+angle+".egslog")
    source_cytoplasm.append("ell_"+str(i).rjust(3, '0')+"_"+celltype+"_cytoplasm_"+angle+".egslog")
    source_membrane.append("ell_"+str(i).rjust(3, '0')+"_"+celltype+"_membrane_"+angle+".egslog")
    source_cell.append("ell_"+str(i).rjust(3, '0')+"_"+celltype+"_cell_"+angle+".egslog")
"""
for i in energies:
...
source_dict={ #filenames; dict key is outout file name
    "ell_source_nucleus":source_nucleus,
    "ell_source_cytoplasm":source_cytoplasm,
    "ell_source_membrane":source_membrane,
    "ell_source_cell":source_cell
}
...
extract('ell_source_nucleus')
extract('ell_source_cytoplasm')
extract('ell_source_membrane')
extract('ell_source_cell')
