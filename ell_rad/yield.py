...
filenames = ['ell_source_nucleus.csv','ell_source_cytoplasm.csv','ell_source_membrane.csv','ell_source_cell.csv']
source = ['N1','Cy1','M1', 'C1']
...
for name in filenames:
    ...
    df.insert(0, "Radionuclides", ['Tc-99m','In-111','I-123','I-125','Tl-201'])
