...
energies=["tc99m","in111","i123","i125","tl201"]
...
for i in energies:
    ...
    source_nucleus.append("ell_"+i+"_"+celltype+"_nucleus_"+angle+".egslog")
    source_cytoplasm.append("ell_"+i+"_"+celltype+"_cytoplasm_"+angle+".egslog")
    source_membrane.append("ell_"+i+"_"+celltype+"_membrane_"+angle+".egslog")
    source_cell.append("ell_"+i+"_"+celltype+"_cell_"+angle+".egslog")
"""
for i in energies:
