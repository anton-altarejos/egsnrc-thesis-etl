...
for i in energies:
    ...
    source_nucleus.append("sph_"+i+"_"+type+"_nucleus.egslog")
    source_cytoplasm.append("sph_"+i+"_"+type+"_cytoplasm.egslog")
    source_membrane.append("sph_"+i+"_"+type+"_membrane.egslog")
    source_cell.append("sph_"+i+"_"+type+"_cell.egslog")
"""
for i in energies:
